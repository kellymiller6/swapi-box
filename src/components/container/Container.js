...
const renderPeople = (people, handleFavorite, favorites) => Object.keys(people).map((person, index) => <PeopleCard
...
const renderPlanets = (planets, handleFavorite, favorites) => Object.keys(planets).map((planet, index) => <PlanetCard key={index}
...
const renderVehicles = (vehicles, handleFavorite, favorites) => Object.keys(vehicles).map((vehicle, index) => <VehicleCard
     key={index}
...
const renderFavorites = (people, planets, vehicles, favorites, handleFavorite) => favorites.map((object) => {
